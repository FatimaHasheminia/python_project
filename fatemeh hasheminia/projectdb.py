...
def logout():
    ...
    lbl_msg.configure(text="you are logged out now!",fg="purple")
    btn_shop.configure(state="disabled")
...
def admin_panel():
   def new_panel():
    ...
    btn_add=tkinter.Button(win_new,text="add",command=add_new_panel)
    btn_add.pack()
   ...
   btn_new=tkinter.Button(win_admin,text="add a new product",command=new_panel)
   btn_new.pack()
